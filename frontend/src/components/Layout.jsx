...
import {
    LayoutDashboard, Truck, Route, Wrench, Receipt, Users, BarChart3, LogOut, Menu, X, Shield, History
} from 'lucide-react';
...
const navItems = [
    ...
    { to: '/maintenance', label: 'Maintenance', icon: Wrench, allowedRoles: ['Manager', 'Dispatcher'] },
    { to: '/expenses', label: 'Expenses', icon: Receipt, allowedRoles: ['Manager', 'Dispatcher', 'Analyst'] },
    ...
    { to: '/audit', label: 'Audit Trail', icon: History, allowedRoles: ['Manager'] },
